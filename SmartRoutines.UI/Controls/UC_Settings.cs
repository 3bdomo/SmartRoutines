...
namespace SmartRoutines.UI.Controls
{
    ...
    public sealed class UC_SettingToggleItem : UserControl
    {
        ...
        {
            Size = new Size(760, 70); BackColor = Color.Transparent;
            ...
            _toggle = new Guna2ToggleSwitch { Checked = initialValue, Location = new Point(700, 22), Size = new Size(50, 24), CheckedState = { FillColor = SmartTheme.Primary }, UncheckedState = { FillColor = SmartTheme.Surface3 } };
    ...
    // ══════════════════════════════════════════════════════════════════════════
    //  UC_SETTINGS (MAIN CLASS)
    // ══════════════════════════════════════════════════════════════════════════

    public partial class UC_Settings : SmartUserControl
    {
        public UC_Settings()
        {
            InitializeComponent();
        ...
        // ══════════════════════════════════════════════════════════════════════
        //  CORE SHORTCUT LOGIC (ProcessCmdKey) - الأختصارات تعمل 100% هنا
        // ══════════════════════════════════════════════════════════════════════
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            {
                TriggerNewRoutine();
                return true; // تم التعامل مع الضغطة
            }
        ...
        public void TriggerNewRoutine()
        {
            SmartDialog.Show(this, "New Routine", "Opening 'Create New Routine' interface...", DialogIconType.Information);
        }

        public void TriggerThemeToggle()
        {
            SmartDialog.Show(this, "Toggle Theme", "Switching application theme mode...", DialogIconType.Information);
        }
        ...
        {
            var mainPanel = new FlowLayoutPanel { Dock = DockStyle.Fill, FlowDirection = FlowDirection.TopDown, WrapContents = false, AutoScroll = true, Padding = new Padding(40, 30, 40, 50), BackColor = Color.Transparent };
            Controls.Add(mainPanel);

            mainPanel.SizeChanged += (_, _) => { int w = Math.Max(400, mainPanel.ClientSize.Width - 80); foreach (Control c in mainPanel.Controls) if (c is not Label) c.Width = w; };
        ...
        {
            var banner = new Guna2GradientPanel { Size = new Size(760, 160), Margin = new Padding(0, 0, 0, 20), FillColor = Color.FromArgb(30, 27, 75), FillColor2 = Color.FromArgb(20, 18, 50), BorderRadius = 18 };
        ...
        {
            var card = new RoundedPanel { Size = new Size(760, 80 + (items.Length * 75)), BackColor = SmartTheme.Surface, Margin = new Padding(0, 0, 0, 20) };
        ...
        {
            var card = new RoundedPanel { Size = new Size(760, 160), BackColor = SmartTheme.Surface, Margin = new Padding(0, 0, 0, 20) };
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                card.Controls.Add(new Label { Text = keys[i], ForeColor = Color.White, BackColor = SmartTheme.Surface3, TextAlign = ContentAlignment.MiddleCenter, Size = new Size(100, 30), Location = new Point(640, y - 5), Font = new Font("Consolas", 10) });
            }
            return card;
        }
        ...
        {
            var card = new RoundedPanel { Size = new Size(760, 280), BackColor = SmartTheme.Surface, Margin = new Padding(0, 0, 0, 20) };
        ...
        {
            if (hl) card.Controls.Add(new Panel { BackColor = SmartTheme.Border, Size = new Size(700, 1), Location = new Point(25, y - 10) });
        ...
        {
            var f = new Panel { Size = new Size(760, 210), Margin = new Padding(0, 40, 0, 40) };
